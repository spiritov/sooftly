...
function _page($$payload) {
  ...
  {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div class="text-3xl svelte-vaijsv">PR</div> <div class="text-4xl svelte-vaijsv">${escape_html(left_pr)}</div>`;
  }
  $$payload.out += `<!--]--></div> <div class="flex-row-reverse items-center gap-2 svelte-vaijsv"><!--[-->`;
  ...
  {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div class="text-3xl svelte-vaijsv">PR</div> <div class="text-4xl svelte-vaijsv">${escape_html(rght_pr)}</div>`;
  }
  $$payload.out += `<!--]--></div> <div class="flex-row items-center gap-2 svelte-vaijsv"><!--[-->`;
