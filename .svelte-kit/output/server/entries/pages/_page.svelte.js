import { z as attr_class, y as escape_html, F as attr, G as stringify, J as ensure_array_like, w as pop, u as push } from "../../chunks/index.js";
...
function RemovableItem($$payload, $$props) {
  ...
  $$payload.out.push(`<button${attr_class(`button ${stringify(sel ? "border-violet-400 bg-violet-300" : "")}`, "svelte-9w7yk0")}><span>${escape_html(name)}</span> `);
  if (isFlag) {
    $$payload.out.push("<!--[-->");
    $$payload.out.push(`<img class="ml-1 flex h-6 self-center"${attr("src", `https://countryflagsapi.netlify.app/flag/${stringify(name)}.svg`)}${attr("alt", name)}/>`);
  } else {
    $$payload.out.push("<!--[!-->");
  }
...
function _page($$payload, $$props) {
  ...
  $$payload.out.push(`<div class="block h-screen bg-zinc-800 svelte-64yon1"><div class="w-full justify-center svelte-64yon1"><div class="mt-8 w-2xl flex-col rounded-md bg-zinc-300/10 p-4 text-center text-lg svelte-64yon1"><div class="mb-8 justify-center text-violet-300 svelte-64yon1">tourney overlay helper</div> <!---->`);
  {
    $$payload.out.push(`<button class="flex w-96 cursor-pointer self-center">${escape_html(arrow)} toggle</button>`);
  }
  $$payload.out.push(`<!----> `);
  {
    $$payload.out.push("<!--[-->");
    const each_array = ensure_array_like(categories);
    $$payload.out.push(`<div class="w-96 flex-col gap-1 self-center svelte-64yon1"><!--[-->`);
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      let [cat, array] = each_array[$$index];
      $$payload.out.push(`<div class="relative justify-center svelte-64yon1">`);
      if (cat == "flag") {
        $$payload.out.push("<!--[-->");
        $$payload.out.push(`<a target="_blank" href="https://countryflagsapi.netlify.app/country-list"><div class="absolute left-0 transition-colors hover:text-violet-300 svelte-64yon1">add ${escape_html(cat)} <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="ml-1 flex size-5 h-full self-center"><path d="M12.232 4.232a2.5 2.5 0 0 1 3.536 3.536l-1.225 1.224a.75.75 0 0 0 1.061 1.06l1.224-1.224a4 4 0 0 0-5.656-5.656l-3 3a4 4 0 0 0 .225 5.865.75.75 0 0 0 .977-1.138 2.5 2.5 0 0 1-.142-3.667l3-3Z"></path><path d="M11.603 7.963a.75.75 0 0 0-.977 1.138 2.5 2.5 0 0 1 .142 3.667l-3 3a2.5 2.5 0 0 1-3.536-3.536l1.225-1.224a.75.75 0 0 0-1.061-1.06l-1.224 1.224a4 4 0 1 0 5.656 5.656l3-3a4 4 0 0 0-.225-5.865Z"></path></svg></div></a>`);
      } else {
        $$payload.out.push("<!--[!-->");
        $$payload.out.push(`<div class="absolute left-0 svelte-64yon1">add ${escape_html(cat)}</div>`);
      }
      $$payload.out.push(`<!--]--> <button class="absolute right-0 cursor-pointer transition-colors hover:text-red-400 hover:underline">remove all</button> `);
      if (cat == "flag") {
        $$payload.out.push("<!--[-->");
        $$payload.out.push(`<input placeholder="alpha-2 code" class="input svelte-64yon1"/>`);
      } else {
        $$payload.out.push("<!--[!-->");
        $$payload.out.push(`<input class="input svelte-64yon1"/>`);
      }
      $$payload.out.push(`<!--]--></div>`);
    }
    $$payload.out.push(`<!--]--> <div class="gap-2 svelte-64yon1"><span>font</span> <button${attr_class(`button ${stringify("bg-violet-300")}`, "svelte-64yon1")}>Ubuntu Mono</button> <button${attr_class(`font-outfit button ${stringify("")}`, "svelte-64yon1")}>Outfit</button></div> <div class="svelte-64yon1"><span>use pr's</span> <input class="ml-2 flex size-4 self-center" type="checkbox"${attr("checked", use_pr, true)}/></div></div>`);
  }
  $$payload.out.push(`<!--]--> <div class="relative mt-8 w-96 justify-center gap-2 self-center svelte-64yon1"><span class="absolute left-0">best of</span> <!--[-->`);
  for (let i = 0, $$length = each_array_1.length; i < $$length; i++) {
    $$payload.out.push(`<button${attr_class(`button size-8 justify-center px-0 ${stringify(i === sel_best_of ? "border-violet-400 bg-violet-300" : "")}`, "svelte-64yon1")}>${escape_html(i * 2 + 1)}</button>`);
  }
  $$payload.out.push(`<!--]--></div> <div class="svelte-64yon1">map</div> <div class="flex-wrap gap-2 svelte-64yon1"><!--[-->`);
  ...
  $$payload.out.push(`<!--]--></div> <div class="mt-4 flex-row justify-between svelte-64yon1"><div class="basis-1/2 flex-col border-r-2 border-zinc-300/10 pr-2 svelte-64yon1"><div class="justify-center svelte-64yon1">left player</div> <div class="flex-wrap gap-2 svelte-64yon1"><!--[-->`);
  ...
  $$payload.out.push(`<!--]--></div> <div class="justify-center svelte-64yon1">flag</div> <div class="flex-wrap gap-2 svelte-64yon1"><!--[-->`);
  ...
  {
    $$payload.out.push("<!--[-->");
    $$payload.out.push(`<div class="mt-4 svelte-64yon1"><div class="svelte-64yon1">map pr:</div> <input${attr("value", left_pr)} class="input svelte-64yon1"/></div>`);
  }
  $$payload.out.push(`<!--]--></div> <div class="basis-1/2 flex-col justify-items-center pl-2 svelte-64yon1"><div class="justify-center svelte-64yon1">right player</div> <div class="flex-wrap gap-2 svelte-64yon1"><!--[-->`);
  ...
  {
    $$payload.out.push("<!--[-->");
    $$payload.out.push(`<div class="mt-4 svelte-64yon1"><div class="svelte-64yon1">map pr:</div> <input${attr("value", rght_pr)} class="input svelte-64yon1"/></div>`);
  }
